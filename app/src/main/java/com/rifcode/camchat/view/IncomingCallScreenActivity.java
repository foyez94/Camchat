...
import com.rifcode.camchat.utils.AudioPlayer;
...
public class IncomingCallScreenActivity extends  BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgvDisplayIMgUSER = findViewById(R.id.imgvDislpayUser);

        mAudioPlayer = new AudioPlayer(this);
        mAudioPlayer.playRingtone();
        mCallId = getIntent().getStringExtra(SinchService.CALL_ID);

//        dbrefUsers.child(ChatUserActivity.user_id_visit)
...
//
//                Picasso.with(IncomingCallScreenActivity.this).load(value).networkPolicy(NetworkPolicy.OFFLINE)
//                        .placeholder(R.drawable.default_user)
//                        .into(imgvDisplayIMgUSER, new Callback() {
//                            @Override
